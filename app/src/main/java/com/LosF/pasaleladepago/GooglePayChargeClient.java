...
public class GooglePayChargeClient {
  ...
  @Nullable private Call<com.LosF.pasaleladepago.ChargeResult> chargeCall;
  ...
  private void onChargeResult(String nonce, com.LosF.pasaleladepago.ChargeResult chargeResult) {
    if (!chargeRequestInFlight()) {
      return;
    }
    chargeCall = null;
